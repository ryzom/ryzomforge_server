/** \file ai_generic_fight_helpers.cpp
 *
 * $Id: ai_generic_fight_helpers.cpp,v 1.10 2007/06/01 11:43:00 dailyserver Exp $
 *
 * This file is used to clean some parts of the fight profiles.
 */
#include "stdpch.h"
