/** \file state_instance.h
 * 
 * $Id: state_instance.h,v 1.57 2006/07/12 14:37:27 boucher Exp $
 * 
 * This file defines the classes CStateInstance and CPersistentStateInstance.
 */
