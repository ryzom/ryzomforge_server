/** \file stats_user_file_list_builders.cpp
 *
 * Part of STATS Module for GUS (general utilities service)
 *
 * $Id: stat_user_file_list_builders.cpp,v 1.3 2007/05/09 15:33:10 boucher Exp $
 */
