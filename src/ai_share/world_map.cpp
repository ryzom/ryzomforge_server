 ...
 * <File description>
 *
 * $Id: world_map.cpp,v 1.75 2006/10/31 16:09:01 blanchard Exp $
 */
...
public:
	...
	explicit CAStarNode(CAStarNode const& other);
...
inline
CAStarNode::CAStarNode(CWorldPosition const& pos)
...
inline
CAStarNode::CAStarNode(CAStarNode const& other)
: _x(other._x)
, _y(other._y)
, _slot(other._slot)
{
