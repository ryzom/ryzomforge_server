/** \file character_inventory_manipulation.cpp
 * character class members for inventory manipulation
 *
 * $Id: character_inventory_manipulation.cpp,v 1.413 2007/07/11 13:52:17 saffray Exp $
 */
