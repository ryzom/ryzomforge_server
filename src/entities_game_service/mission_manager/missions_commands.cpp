/** \file ai_id_translator.cpp
 * <File description>
 *
 * $Id: missions_commands.cpp,v 1.36 2007/05/09 15:33:36 boucher Exp $
 */
...
// targetMissionDump
//-----------------------------------------------
NLMISC_COMMAND(targetMissionDump,"dump missions of the target","<character_id>")
{
	if (args.size() != 1)
		return false;
	...
	if ( c->getTarget().getType() != RYZOMID::player )
		return false;
