/** \file egs_variables.cpp
 *
 * $Id: egs_variables.cpp,v 1.107 2007/05/31 13:58:13 coutelas Exp $
 */
...
CVariable<uint32> GuildMaxMemberCount("egs","GuildMaxMemberCount", "", 500, 0, true);
