/** \file offline_character_command.h
 * Singleton received and store command for offline characters until character are online for apply
 *
 * $Id: offline_character_command.h,v 1.14 2006/05/31 12:15:01 boucher Exp $
 */
