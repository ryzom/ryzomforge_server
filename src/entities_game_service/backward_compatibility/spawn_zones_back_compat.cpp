/** \file spawn_zones_back_compat.cpp
 * Used for backward compatibility with branch 1_0_1
 *
 * $Id: spawn_zones_back_compat.cpp,v 1.4 2007/06/20 18:03:28 dailyserver Exp $
 */
