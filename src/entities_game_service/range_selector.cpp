 ...
 * trap 14.12.2004 : range selector is no more a template class because we use it only for CEntityBase
 *
 * $Id: range_selector.cpp,v 1.7 2007/05/09 15:33:06 boucher Exp $
 */
