...
/** \file shard_unifier_client.cpp
 *	This module act as a client for some relation of the EGS with the shard unifier (SU).
 *
 * $Id: shard_unifier_client.cpp,v 1.12 2007/06/01 14:44:27 boucher Exp $
 */
