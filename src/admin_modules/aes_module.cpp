/** This file declare the Admin Executor Service module.
 *	This module control of services (start, stop, execute command and query state)
 *	This module report it's status to the AS module.
 */
