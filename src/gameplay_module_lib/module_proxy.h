/** \file module_proxy.h
 * A proxy to a module core. Usulful to abstract the core completly . DO NOT INCLUDE THIS FILE INCLUDE "gameplay_module.h"
 *
 * $Id: module_proxy.h,v 1.1 2004/07/20 09:31:15 brigand Exp $
 */
