/** \file msg_brick_service.h
 * Definition of all classes used in messages for communication with (at destination to) the brick_service
 *
 * $Id: msg_brick_service.h,v 1.39 2007/03/09 09:56:52 boucher Exp $
 */
