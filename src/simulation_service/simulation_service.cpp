/** \file simulation_service.cpp
 * Simulation Service (SS)
 *	This service will simulate loading of the server system
 *	 e.g. due to multiple clients uploading player-created scenarios
 *
 * $Id: simulation_service.cpp, AJM, 2005/10/10
 */
